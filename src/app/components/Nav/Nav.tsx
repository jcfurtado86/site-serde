        ...
        <div className="relative container mx-auto px-6 py-3">
          <div className="flex justify-between items-center mb-1">
            <Link href="/" className="flex items-center gap-2">
              <Image src="/image/serde-planta.png" alt="Logo" width={150} height={150} className="w-auto h-8 md:h-12" />
            ...
            <div className="flex flex-col h-full">
              <div className="flex items-center justify-between p-4 border-b border-gray-200">
                <div className="flex items-center pl-2">
                  <Image src="/image/serde-planta.png" alt="Logo" width={100} height={100} className="w-auto h-8" />
