...
export default function About() {
    return (
        <div className="w-full bg-gradient-to-b from-gray-50 to-white flex flex-col items-center p-4 pb-2 pt-2 sm:p-6 sm:pb-4 sm:pt-4 lg:p-8 lg:pb-6 lg:pt-6" id="sobre">
            <div className="max-w-[1240px] mx-auto pt-8 md:pt-6 pb-4 md:pb-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <Link href="/projetos-pesquisa" className="group bg-white p-6 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.16)] transition-all duration-300 hover:-translate-y-1">
                        <div className="flex justify-center mb-6">
                            <div className="bg-blue-50 p-4 rounded-xl group-hover:bg-blue-100 transition-colors">
                                <svg className="w-12 h-12 text-[#1565C0] group-hover:text-[#1565C0] transition-colors" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <Link href="/recursos-humanos" className="group bg-white p-6 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.16)] transition-all duration-300 hover:-translate-y-1">
                        <div className="flex justify-center mb-6">
                            <div className="bg-green-50 p-4 rounded-xl group-hover:bg-green-100 transition-colors">
                                <svg className="w-12 h-12 text-[#2E7D32] group-hover:text-[#2E7D32] transition-colors" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <Link href="/publicacoes" className="group bg-white p-6 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.16)] transition-all duration-300 hover:-translate-y-1">
                        <div className="flex justify-center mb-6">
                            <div className="bg-orange-50 p-4 rounded-xl group-hover:bg-orange-100 transition-colors">
                                <svg className="w-12 h-12 text-[#EF6C00] group-hover:text-[#EF6C00] transition-colors" viewBox="0 0 24 24" fill="currentColor">
