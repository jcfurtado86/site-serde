...
import { ResearchLineList } from '@/app/(pages)/projetos-pesquisa/components/ResearchLine/ReaserchLine'
      ...
      <div className="max-w-[1240px] mx-auto pt-8 md:pt-6 pb-4 md:pb-2">
        <div className="text-center mb-8 md:mb-6">
          ...
          <p className="pt-5 text-gray-600 text-sm sm:text-base lg:text-lg max-w-4xl mx-auto leading-relaxed pb-10">
            ...
            pesquisam já verificaram que os profissionais aprendem mais sobre estas atividades durante o seu trabalho do
            que durante a sua formação e em geral, a indústria de software sofre com a falta de profissionais
            qualificados para trabalhar em atividades que envolvem o processo de desenvolvimento de software. Esta
            dificuldade em encontrar profissionais de Ciência da Computação com domínio dos tópicos da Engenharia de
            Software pode estar relacionada ao tipo de formação que estes receberam durante os anos de graduação. Assim,
            neste contexto, este projeto tem como objetivo desenvolver metodologias e ferramentas que auxiliem na
            aplicação e no ensino dos conteúdos da Engenharia de Software, seja no âmbito acadêmico ou na indústria de
            software.
          </p>
        </div>
        {/*linhas de pesquisa*/}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          ...
          >
            ...
            <h3 className="text-xl lg:text-2xl font-bold text-center mb-4 text-black">Linhas e Projetos de Pesquisa</h3>
            <p className="text-gray-600 text-center">
              Acesse aqui as linhas de pesquisa do grupo e os projetos de pesquisa em andamento e já encerrados
            </p>
          </Link>
          ...
          >
            ...
            <h3 className="text-xl lg:text-2xl font-bold text-center mb-4 text-black">Recursos Humanos</h3>
            <p className="text-gray-600 text-center">
              Esta página contém a lista de docentes e discentes que fazem parte do grupo, bem como a atuação de cada um
          ...
          >
            ...
            <h3 className="text-xl lg:text-2xl font-bold text-center mb-4 text-black">Publicações</h3>
            <p className="text-gray-600 text-center">
              Visualize as publicações geradas pelos integrantes do grupo de pesquisa, sejam elas artigos, livros,
          ...
          >
            ...
            <h3 className="text-xl lg:text-2xl font-bold text-center mb-4 text-black">Orientações</h3>
            <p className="text-gray-600 text-center">
              Conheça os trabalhos de orientação em andamento e concluídos pelos docentes do grupo de pesquisa
            </p>
          </Link>
        </div>
