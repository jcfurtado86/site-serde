        ...
        <div className="w-full bg-gray-50 flex flex-col items-center p-4 pb-2 pt-2 sm:p-6 sm:pb-4 sm:pt-4 lg:p-8 lg:pb-6 lg:pt-6" id="sobre">
            <div className="max-w-[1240px] mx-auto pt-8 md:pt-6 pb-4 md:pb-2">
                <div className="text-center mb-8 md:mb-6">
                    ...
                    <p className="pt-5 text-gray-600 text-sm sm:text-base lg:text-lg max-w-7xl mx-auto leading-relaxed pb-10">
            ...
            <div className="mt-12 text-center">
                    <Link 
                        ...
                        target="_blank"
                        className="text-blue-600 hover:text-blue-800 inline-flex items-center gap-2 transition-colors duration-300 border-2 border-blue-600 rounded-lg px-4 py-2 mt-6"
                    >
