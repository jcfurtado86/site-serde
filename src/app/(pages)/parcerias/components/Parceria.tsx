...
export const Parceria = ({ parceria }: { parceria: ParceiroProps }) => {
  return (
    <Link
      ...
      className="group relative flex h-72 flex-col rounded-2xl border border-gray-200 bg-white py-6 px-6 lg:px-10 shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
    >
      ...
      <div className="flex flex-grow flex-col text-center">
        ...
        <p className="flex-grow text-sm text-gray-600 line-clamp-2">{parceria.description}</p>
      </div>
    </Link>
  )
}
