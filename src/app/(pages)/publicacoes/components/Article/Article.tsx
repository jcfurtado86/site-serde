  ...
  const articles: ArticleProps[] = [
    {
      number: 6,
      title:
        "A evasão dos estudantes em cursos de computação: um estudo sobre a Universidade Federal do Amapá. CADERNO PEDAGÓGICO (LAJEADO. ONLINE), v. 21, p. e7820, 2024",
    ...
    },
    {
      number: 10,
      title:
        "Desafios enfrentados por profissionais e empresas da área de t.i. durante a pandemia de covid-19 no Brasil. CADERNO PEDAGÓGICO (LAJEADO. ONLINE), v. 21, p. e3944, 2024",
      link: "#",
    ...
    },
    {
      number: 5,
      title:
        "PROJ-O-POLY: um jogo de banco imobiliário de apoio ao ensino da gerência de projetos. CADERNO PEDAGÓGICO (LAJEADO. ONLINE), v. 21, p. e6306, 2024",
    ...
    },
    {
      number: 15,
      title:
        "SPIDER: Uma Proposta de Solução Sistêmica de um SUITE de Ferramentas de Software Livre de Apoio à Implementação do Modelo MPS.BR. Revista do Programa Brasileiro da Qualidade e Produtividade em Software, v. 2, p. 103-107, 2011",
      link: "#",
      participants: [
        "OLIVEIRA, S. R. B.",
        "YOSHIDOME, E.",
    ...
    },
    {
      number: 13,
      title:
        "Projeto SPIDER ? Software Process Improvement: DEvelopment and Research. Revista do Programa Brasileiro da Qualidade e Produtividade em Software, v. 3, p. 98-103, 2012",
      link: "#",
      participants: [
        "OLIVEIRA, S. R. B.",
        "PORTELA, C. S.",
    ...
    },
    {
      number: 2,
      title:
        "Um estudo sobre as principais dificuldades na empregabilidade de um engenheiro de software. CONTRIBUCIONES A LAS CIENCIAS SOCIALES, v. 17, p. 1-21, 2024",
    ...
    },
    {
      number: 8,
      title:
        "An electrogram-guided transvenous temporary pacemaker implant simulator. PACE-PACING AND CLINICAL ELECTROPHYSIOLOGY, p. 1-9, 2023",
    ...
    },
    {
      number: 1,
      title:
        "Uma abordagem focada no aluno para o ensino de engenharia de requisitos. CUADERNOS DE EDUCACIÓN Y DESARROLLO, v. 16, p. 264-282, 2024",
    ...
    },
    {
      number: 7,
      title:
        "Apoio ao Ensino da Construção de Produto de Software a partir do uso de um RPG: o Jogo ConES. REVISTA EDUCAONLINE, v. 17, p. 100-115, 2023",
      link: "",
    ...
    },
    {
      number: 9,
      title:
        "An Experimental Evaluation of a Teaching Approach for Statistical Process Control in Computer Courses. INTERNATIONAL JOURNAL OF INFORMATION AND COMMUNICATION TECHNOLOGY EDUCATION, v. 17, p. 154-171, 2021",
    ...
    },
    {
      number: 16,
      title:
        "WISE: Uma Abordagem Sistêmica Para Uso Na Avaliação MPS.BR. Traços (UNAMA), v. 11, p. 93-108, 2009",
      link: "",
      participants: [
        "FURTADO, Julio C.",
        "OLIVEIRA, Sandro Ronaldo Bezerra",
        "ALBUQUERQUE, Carlos Alberto C.",
      ],
      year: 2009,
      importance: 11,
    },
    {
      number: 14,
      title:
        "Uma Proposta de Processo para Aquisição de Software e Serviços Correlatos Baseada no CMMI- ACQ e no Guia de Implementação do MPS.BR. Revista do Programa Brasileiro da Qualidade e Produtividade em Software, v. 3, p. 109-114, 2012",
      link: "",
    ...
    },
    {
      number: 12,
      title:
        "A Process Framework for the Software and Related Services Acquisition Based on the CMMI-ACQ and the MPS.BR Acquisition Guide. Revista IEEE América Latina, v. 10, p. 2256-2262, 2012",
    ...
    },
    {
      number: 3,
      title:
        "Um curriculum para ensino de melhoria do processo de software em cursos de computação. CADERNO PEDAGÓGICO (LAJEADO. ONLINE), v. 21, p. e3722, 2024",
    ...
    },
    {
      number: 11,
      title:
        "Experimental Evaluation of a Serious Game for Teaching Software Process Modeling. IEEE Transactions on Education, p. 1-8, 2015",
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          ...
          {sortedArticles.filter(
            ...
            <div className="text-center py-10">
              <p className="text-gray-500 text-lg">Nenhum artigo encontrado para "{searchTerm}"</p>
            </div>
          )}
        </div>
      </div>
