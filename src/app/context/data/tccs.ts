...
export const tccs: TCCProps[] = [
  ...
  {
    title:
      "A Importância da Formação de Professores para Práticas Inclusivas Voltadas a Estudantes com Transtorno do Espectro Autista (TEA) nas Séries Iniciais da Secretaria de Estado da Educação do Distrito Federal",
    description: "",
    link: "a-importancia-da-formacao-de-professores-para-praticas-inclusivas-voltadas-a-estudantes-com-transtor",
    status: "Em andamento",
    students: ["Cíntia Freitas Martins"],
    advisor: "Julio Cezar Costa Furtado",
    year: "2026",
    keywords: "",
    degree: "Mestrado",
    ...
    course_en: "Professional Master's in Inclusive Education National Network",
    title_en:
      "The Importance of Teacher Training for Inclusive Practices Aimed at Students with Autism Spectrum Disorder (ASD) in the Early Grades of the Federal District Department of Education",
  },
  {
    title:
  ...
  {
    title:
      "Residência Tecnológica no Judiciário: Um Relato de Experiência em Transformação Digital",
    description: "A transformação digital do Poder Judiciário brasileiro, impulsionada pela agenda Justiça 4.0 do Conselho Nacional de Justiça, confronta os tribunais com um desafio estrutural, o déficit persistente de profissionais especializados em Tecnologia da Informação e Comunicação no setor público. Nesse contexto, a residência tecnológica emerge como alternativa ao modelo clássico de terceirização, ao combinar formação acadêmica imersiva com a produção de soluções digitais em ambiente institucional real. Este trabalho analisou a experiência da Residência Tecnológica TJAP-UNIFAP, parceria entre o Tribunal de Justiça do Estado do Amapá e a Universidade Federal do Amapá, instituída em 2024, a partir de dois ângulos complementares, a perspectiva formativa dos discentes residentes e a perspectiva institucional dos servidores que com eles interagem diretamente. Adotou-se desenho de estudo de caso com métodos mistos convergentes, articulando questionários em escala Likert, análise temática reflexiva dos relatos de experiência dos residentes e análise de conteúdo das respostas abertas dos servidores. Os achados, lidos à luz dos referenciais de aprendizagem situada, cognitive apprenticeship, phronesis e capacidade estatal multidimensional, indicam avaliação amplamente positiva por ambos os grupos, com a residência operando, na ótica dos discentes, como ambiente de aprendizagem situada em contexto institucional autêntico e, na ótica dos servidores, como aporte efetivo de capacidade técnica e de cooperação interinstitucional. A leitura cruzada das duas perspectivas evidencia convergências quanto ao reconhecimento do aporte técnico e da aproximação entre universidade e Poder Judiciário, complementaridades entre o mecanismo formativo e o resultado institucional percebido, e tensões convergentes relativas à sustentabilidade, ao vínculo dos residentes e à escala do programa. Conclui-se que a residência tecnológica universidade-tribunal opera como mecanismo híbrido de fortalecimento de capacidade estatal, cuja principal vulnerabilidade não reside na qualidade do que produz, e sim nas condições estruturais que asseguram sua continuidade.",
    link: "residencia-tecnologica-no-judiciario-um-relato-de-experiencia-em-transformacao-digital",
    status: "Finalizado",
    students: ["Luiz Felipe Moreira dos Anjos"],
    advisor: "Julio Cezar Costa Furtado",
    year: "2026",
    keywords: "Residência tecnológica, Transformação digital, Poder judiciário, Aprendizagem situada, Capacidade estatal, Ciência da Computação",
    degree: "Graduação",
    course: "Graduação em Ciência da Computação",
    course_en: "Bachelor's in Computer Science",
    documentation: [
      { name: "Texto Completo", type: "article", link: "/tccs/residencia-tecnologica-judiciario.pdf" },
    ],
    title_en: "Technology Residency in the Judiciary: An Experience Report on Digital Transformation",
    description_en: "The digital transformation of the Brazilian Judiciary, driven by the National Council of Justice's Justiça 4.0 agenda, confronts courts with a structural challenge, the persistent deficit of Information and Communication Technology professionals in the public sector. In this context, technology residency emerges as an alternative to the classical outsourcing model, combining immersive academic training with the production of digital solutions in a real institutional environment. This study analyzed the experience of the TJAP-UNIFAP Technology Residency, a partnership between the Court of Justice of the State of Amapá and the Federal University of Amapá, established in 2024, from two complementary perspectives, the formative perspective of the student residents and the institutional perspective of the public servants who interact directly with them. A case study design with convergent mixed methods was adopted, combining Likert-scale questionnaires, reflexive thematic analysis of the residents' experience reports, and content analysis of the servants' open-ended responses. The findings, read through the frameworks of situated learning, cognitive apprenticeship, phronesis, and multidimensional state capacity, indicate broadly positive evaluations by both groups, with the residency operating, from the residents' standpoint, as an environment of situated learning in an authentic institutional context and, from the servants' standpoint, as an effective contribution of technical capacity and interinstitutional cooperation. The cross-reading of the two perspectives reveals convergences regarding the recognition of the technical contribution and the approximation between university and Judiciary, complementarities between the formative mechanism and the perceived institutional outcome, and convergent tensions concerning the program's sustainability, the residents' employment ties, and its scale. It is concluded that the university-court technology residency operates as a hybrid mechanism for strengthening state capacity, whose main vulnerability lies not in the quality of what it produces but in the structural conditions that ensure its continuity.",
    keywords_en: "Technology residency, Digital transformation, Judiciary, Situated learning, State capacity, Computer Science",
  },
  {
    title:
      "Proposta de um Manual de Implementação da Clean Architecture em Projetos Node.js com Typescript",
    description: "A crescente complexidade dos sistemas de software exige abordagens arquiteturais que promovam manutenibilidade, testabilidade e independência de tecnologias específicas. Nesse contexto, a Clean Architecture, proposta por Robert C. Martin, apresenta um modelo que organiza o software em camadas bem definidas, com regras claras de dependência, visando proteger o núcleo de regras de negócio contra mudanças externas. Este trabalho tem como objetivo propor um manual de implementação da Clean Architecture em projetos Node.js com TypeScript, demonstrado por meio do desenvolvimento de uma API RESTful. Para atingir esse objetivo, foi desenvolvido um sistema de gerenciamento de listas de tarefas, no qual usuários podem criar listas e gerenciar tarefas associadas. O projeto foi estruturado de acordo com os princípios da Clean Architecture, separando as camadas de entidades, casos de uso, adaptadores de interface e infraestrutura, e cada camada foi implementada de modo a respeitar a regra de dependência, mantendo o domínio e a lógica da aplicação independentes de frameworks, mecanismos de persistência e protocolos de comunicação. A avaliação, de natureza qualitativa e baseada em um estudo de caso único, apoiou-se em evidências extraídas do próprio código e em indicadores estruturais. Os resultados observados apontam maior clareza estrutural e indícios de menor acoplamento entre componentes, além de um núcleo passível de verificação isolada, sem dependência de banco de dados ou de framework, o que favorece a testabilidade. A avaliação indica que a Clean Architecture é aplicável mesmo em sistemas de menor complexidade, ainda que ao custo de maior esforço inicial de organização. A sistematização das decisões de implementação, das boas práticas e dos erros frequentes em formato de manual oferece um material de referência para estudantes e desenvolvedores. Assim, o trabalho discute, na prática, tanto os benefícios quanto os limites da aplicação de princípios arquiteturais bem definidos no desenvolvimento de sistemas backend modernos.",
    link: "proposta-de-um-manual-de-implementacao-da-clean-architecture-em-projetos-nodejs-com-typescript",
    status: "Finalizado",
    students: ["Vitor Hugo Amanajás Rocha", "Felipe da Silva Rodrigues"],
    advisor: "Julio Cezar Costa Furtado",
    year: "2026",
    keywords: "Clean Architecture, Arquitetura de software, Node.js, TypeScript, API RESTful",
    degree: "Graduação",
    course: "Graduação em Ciência da Computação",
    course_en: "Bachelor's in Computer Science",
    documentation: [
      { name: "Texto Completo", type: "article", link: "/tccs/clean-architecture-nodejs.pdf" },
    ],
    title_en: "Proposal for a Clean Architecture Implementation Manual for Node.js Projects with TypeScript",
    description_en: "The increasing complexity of software systems requires architectural approaches that improve maintainability, testability and independence from specific technologies. In this context, Clean Architecture, proposed by Robert C. Martin, organizes software into welldefined layers and establishes dependency rules to protect business rules from external changes. This work aims to propose an implementation manual for Clean Architecture in Node.js projects with TypeScript, demonstrated through the development of a RESTful API. To achieve this objective, a task list management system was developed. In this system, users can create lists and manage related tasks. The project was structured according to the principles of Clean Architecture, separating entities, use cases, interface adapters and infrastructure, and each layer was implemented to respect the dependency rule, keeping the domain and application logic independent from frameworks, persistence mechanisms and communication protocols. The evaluation, qualitative in nature and based on a single case study, relied on evidence drawn from the source code and on structural indicators. The observed results point to clearer structure and signs of lower coupling between components, as well as a core that can be verified in isolation, without depending on a database or framework, which favors testability. The analysis indicates that Clean Architecture can be applied even in systems with simple business rules, although at the cost of greater initial organization effort. Systematizing the implementation decisions, good practices and common mistakes in the form of a manual provides reference material for students and developers. Thus, the work discusses, in practice, both the benefits and the limits of applying well-defined architectural principles in the development of modern backend software.",
    keywords_en: "Clean Architecture, Software architecture, Node.js, TypeScript, RESTful API",
  },
  {
    title:
  ...
  },
  {
    ...
    course_en: "Bachelor's in Computer Science",
    documentation: [
      { name: "Repositório UNIFAP", type: "article", link: "https://repositorio.unifap.br/handle/123456789/2227" },
    ],
